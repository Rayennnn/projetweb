...
include 'C:\xampp\htdocs\PROJETWEB\model\suggestion.php';
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $updatedSuggestion = new Suggestion(
        ...
        $_POST['statut'],
        $_POST['type_feedback'],
        $_POST['mail'] // Remplacement par mail
    );
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Mettre à jour une suggestion</h2>
        ...
        <div class="form-container">
            <form method="POST" action="" class="form-content">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="mail" value="<?= htmlspecialchars($suggestion['mail']); ?>">
                    <input type="text" class="form-control" value="<?= htmlspecialchars($suggestion['mail']); ?>" readonly>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="listesuggestion.php" class="btn btn-secondary">
