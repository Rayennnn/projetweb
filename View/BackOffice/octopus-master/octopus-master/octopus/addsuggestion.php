...
try {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($result) {
            header('Location: /projetweb/view/FrontOffice/online-courses-html-template/contact.php?success=1');
        } else {
    ...
    header('Location: /projetweb/view/FrontOffice/online-courses-html-template/contact.php?error=' . urlencode($e->getMessage()));
}
?>
