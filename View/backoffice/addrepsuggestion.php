        ...
        <div class="form-container">
            ...
            <form id="addReponseSuggestionForm" method="POST" action="">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="reponse" id="reponse" required></textarea>
                </div>

                <div class="form-group">
                    <label for="date_reponse">Date de Réponse</label>
                    <input type="date" class="form-control" name="date_reponse" id="date_reponse" required>
                </div>

                <div class="form-group">
                    <label for="id_suggestion">ID Suggestion</label>
                    <input type="text" class="form-control" name="id_suggestion" id="id_suggestion" required>
                </div>
