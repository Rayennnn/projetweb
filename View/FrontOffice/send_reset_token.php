...
require 'C:/xampp/htdocs/PROJETWEB/PHPMailer/src/Exception.php';
require 'C:/xampp/htdocs/PROJETWEB/PHPMailer/src/PHPMailer.php';
require 'C:/xampp/htdocs/PROJETWEB/PHPMailer/src/SMTP.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user) {
        ...
        // Envoyer l'e-mail
        $resetLink = "http://localhost/parcouri/view/front/reset.php?token=$token";
