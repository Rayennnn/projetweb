...
<html class="fixed">
	<head>
		...
		<!-- Web Fonts  -->
		<link rel="stylesheet" href="./styles/admin/comments.css">
					...
					<div>
					    ...
					    <div class="report-container">
					        <div class="report-header">
					          <h1 class="recent-Articles">Recent Comments</h1>
					          <div style="width: 25px; height: 25px; cursor:pointer;" id="deleteAllComments"> <img style="width:100%;height:100%;" src="./img/delete.svg" alt="delete"></div>
					        </div>
